...
gates.set_alpha(200)
intro = pygame.image.load(os.path.join('intro.png'))
intro.set_alpha(400)
gameOver_A= pygame.image.load(os.path.join('gameOver_A.png'))
gameOver_A.set_alpha(200)
gameOver_B= pygame.image.load(os.path.join('gameOver_B.png'))
gameOver_B.set_alpha(200)
gameOver_C= pygame.image.load(os.path.join('gameOver_C.png'))
gameOver_C.set_alpha(200)
gameOver_D = pygame.image.load(os.path.join('gameOver_D.png'))
gameOver_D.set_alpha(200)
gameOver_F= pygame.image.load(os.path.join('gameOver_F.png'))
...
def main():
    ...
    while run:
        ...
        if gameStart==True and gameOver==False:
            if counter%speed==0: 
                launchFood()
            if counter%500==0 and counter != 0 and speed>5:
                speed//=1.5
